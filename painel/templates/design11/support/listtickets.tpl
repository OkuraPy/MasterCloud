<div class="spacing">
    ...
    <div class="bottom-border-nav">
        ...
        <table class="table table-striped table-spacing tickets-table table-fixed-layout">
            <thead>
                <tr>
                    ...
                    <th class="visible-desktop">
                        <a href="{$ca_url}tickets/&orderby=name|ASC" data-sorter="orderby" ><i class="icon-sort"></i>{$lang.department}</a>
                    </th>
                    <th>
                        <a href="{$ca_url}tickets/&orderby=date|ASC" ><i class="icon-sort"></i>{$lang.date}</a>
                    </th>
                    <th class="visible-desktop visible-tablet">
