        ...
        <div class="spacing">
            ...
            <div class="bottom-border-nav">
                ...
                <table class="table table-striped table-spacing services-table">
                    ...
                    <tr>
                        <th class="w5 hidden-phone" ><input type="checkbox" onclick="return c_all(this);"></th>
                        <th><a href="{$ca_url}clientarea/domains/&orderby=name|ASC" data-sorter="orderby"><i class="icon-sort"></i> {$lang.domain}</a></th>
                        <th class="visible-desktop" style="width: 130px">
                            <a href="{$ca_url}clientarea/domains/&orderby=date_created|ASC" data-sorter="orderby"><i class="icon-sort"></i> {$lang.registrationdate}</a>
                        </th>
                        <th style="width: 130px">
                            <a href="{$ca_url}clientarea/domains/&orderby=expires|ASC" data-sorter="orderby"> <i class="icon-sort"></i> {$lang.expirydate}</a>
                        </th>
                        <th style="width: 130px">
                            <a href="{$ca_url}clientarea/domains/&orderby=expires|ASC" data-sorter="orderby"><i class="icon-sort"></i> {$lang.status}</a>
                        </th>
                        <th class="visible-desktop" colspan="2" style="width: 110px">{$lang.autorenew}</th>
