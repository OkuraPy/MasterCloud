...
<div class="spacing">
    ...
    <div class="h-description">{$lang.currentbalancestatus}</div>
    ...
    <div class="bottom-border-nav">
        ...
        <table class="table table-striped table-spacing">
            <thead>
                <tr>
                    {if $enableFeatures.bulkpayments!='off'}<th width="14" class="hidden-phone"></th>{/if}
                    ...
                    <th class="w10 visible-desktop"><a href="{$ca_url}clientarea&amp;action=invoices&amp;orderby=date|ASC"  data-sorter="orderby"><i class="icon-sort"></i>{$lang.invoicedate}</a></th>
                    <th class="w10 hidden-phone"><a href="{$ca_url}clientarea&amp;action=invoices&amp;orderby=duedate|ASC"  data-sorter="orderby"><i class="icon-sort"></i>{$lang.duedate}</a></th>
                    <th class="w5 visible-desktop"></th>
                </tr>
            </thead>
