<div class="knowledgebase">
    {if $action=='article'}
        {if $article}
            ...
            <div class="brcrm" style="background:#ECF0F1;">
                ...
                <a class="btn right btn-default btn-small" href="{$ca_url}knowledgebase/"><i class="icon-chevron-left icon-white"></i> {$lang.back}</a>
    ...
    {elseif $action=='category'}
        ...
        <div class="brcrm" style="background:#ECF0F1;">
            ...
            <a class="btn right btn-small" href="{$ca_url}knowledgebase/"><i class="icon-chevron-left icon-white"></i> {$lang.back}</a>
            <div class="clear"></div>
        </div>
        <div class="spacing">
