{if $action=='passreminder'}
    <div id="loginbox_container">
        <div class="wbox">
            <div class="wbox_header">{$lang.didyouforget} <a href="{$ca_url}clientarea/" class="right btn btn-mini"><i class="icon-chevron-left icon-white"></i> {$lang.login}</a><div class="clear"></div></div>
                        ...
                        {if $enableFeatures.logincaptcha =='on'}
                            <tr>   
                                <td align="left" colspan="2">
                                    ...
                                    <input name="captcha" class="styled"  type="text" style="width:96%"/>
