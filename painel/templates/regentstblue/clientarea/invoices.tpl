...
<div class="bottom-border-nav">
    <ul class="nav nav-pills ">
        ...
        {if $enableFeatures.deposit!='off' }
            <li>
                <a href="{$ca_url}clientarea/addfunds/" class="color-green"> <i class="icon-plus icon-white"></i>  {$lang.addfunds}</a>
            </li>
        {/if}
        {if $acc_balance && $acc_balance>0 && $enableFeatures.bulkpayments!='off'}
            <li>
                <a href="#" onclick="$(this).next().submit();
                    ...
                    <i class="icon icon-Tag"></i> <span class="payall-all">{$lang.paynowdueinvoices}</span>
