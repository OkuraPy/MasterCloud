...
<div class="brcrm">
    ...
    <a class="btn btn-small btn-default right" href="{$ca_url}tickets/"><i class="icon-chevron-left icon-white"></i> {$lang.back}</a>
                ...
                <tr>
                    <td colspan="2" >
                        <div class="form-actions">
                            ...
                            <div class="right">
                                <button type="submit" class="btn btn-success btn-large progress-button" data-horizontal="" data-style="shrink" id="submitbutton"><i class="icon icon-Pencil"></i> {$lang.submit}</button>
                            </div>
                            <div class="clear"></div>
                        </div>
                    </td>
