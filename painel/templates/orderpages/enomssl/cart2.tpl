...
<form id="mform" action="" method="post">
	<div id="celeft">
							...
							<td width="60%">
								<table class="checker" width="100%" cellpadding="0" cellspacing="0">
									...
									<tr>
										...
										<td><select name="organization[country]" class=" tipsing" title="{$lang.en_tip6} ">
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top:10px">
			<tr>
				{if !$noorg}<td width="50%" valign="top" style="padding-right:5px;" >
					<div class="wbox">
						<div class="wbox_header">{$lang.en_admincontact}</div>
						<div class="wbox_content" >
