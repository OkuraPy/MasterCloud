        ...
        {if $logged!="1"}
            ...
            <div>
                ...
                <div class="reg" id="logmein" {if $action=='login'}{else}style="display:none"{/if}>
                    <form method="post" action="" id="loginform1"><input type="hidden" name="action" value="login"/>
                        ...
                        <ul>
                            <li class="d-label"><d-label for="emailaddres">{$lang.email}:</d-label></li>
                            <li class="input"><input type="text" name="username" id="emailaddres"></li>
                            <li class="d-label"><d-label for="passwoerd">{$lang.password}:</d-label></li>
                            <li class="input"><input type="password" name="password" id="passwoerd"></li>

                        </ul>
                        <a href="#" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" style="float:right" role="button" onclick="$('#loginform1').submit();
                                        return false;">
                            <span class="ui-button-text">{$lang.login}</span></a>
                        <div class="clear"></div>
                    </form>
                </div>
            </div>
            ...
            <form method="post" action="" id="checkoutform" class="form-horizontal">
                ...
                <div class="reg" id="regme" {if $action=='login'}style="display:none"{else}{/if}>
                    ...
                    {include file='dedicated/signup.tpl'}
