            ...
            <tbody>
                {if !$custom_filters}
                    ...
                    <tr>
                        ...
                        <td>{$lang.Service}</td>
                        <td >
                            <select name="filter[product_id]">
                                <option value=''>{$lang.Any}</option>
                                {foreach from=$advanced.products item=category}
                                    <optgroup label="{$category.name}">
                                        {foreach from=$category.products item=product}
                                            <option value="{$product.id}" {if $currentfilter.product_id==$product.id}selected="selected"{/if}>{$product.name}</option>
                                        {/foreach}
                                    </optgroup>
                                {/foreach}
                            </select>
                ...
                {/if}
                <tr>
                    <td>{$lang.Server}</td><td colspan="5"><select name="filter[server_id]">
                            <option value=''>{$lang.Any}</option>
