                        ...
                        <tr>
                            ...
                            <td>
                                <span>
                                    ...
                                    <input type="button" onclick="$(this).parent().hide().next().show();
                                            return false;" value="{$lang.Change}"/>
                                ...
                                <td>
                                    ...
                                    {if $referral || $referrals}
                                        ...
                                        <div {if $referral}style="display: none"{/if}>
                                            <select name="referral" onchange="if ($(this).val() != '0')
        ...
        {/if}            {literal}
            ...
            <div style="text-align:center;margin-bottom:7px;padding:15px 0px;" class="p6 secondtd">
                ...
                <a onclick="$('input[name=markaccepted]').click();
                        return false;" href="#" class="menuitm {if $details.status=='Active'}disabled{else}greenbtn{/if}"><span>{$lang.acceptorder}</span></a>
                <a onclick="$('input[name=markcancelled]').click();
                        return false;" href="#" class="menuitm {if $details.status=='Cancelled'}disabled{/if}"><span>{$lang.cancelorder}</span></a>
                <span class="orspace">{$lang.Or}</span>

                <a onclick="$('input[name=markpending]').click();
                        return false;" href="#" class="menuitm menuf {if $details.status=='Pending'}disabled{/if}" ><span>{$lang.settopending}</span></a><!--
                --><a onclick="$('input[name=markfraud]').click();
                        return false;" href="#" class="menuitm menu{if !$forbidAccess.deleteOrders}c{else}l{/if} {if $details.status=='Fraud'}disabled{/if}"><span>{$lang.setasfraud}</span></a><!--
