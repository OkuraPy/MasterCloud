    ...
    <tr>
        <td colspan="2" style="padding:0px;">
                ...
                <div class="list-2">
                    <div class="subm1 haveitems">
                        ...
                        {if $product.visible=='1'}
                            ...
                            <li><a href="#" onclick=" $('#prod_visibility').val(-1);$('#archivemsg').show();saveProductFull();"><span >Archive</span></a></li>
                        {/if}
            ...
            <div class="imp_msg" style="margin-top:10px;{if $product.visible!='0'}display:none{/if}" id="hiddenmsg">
                ...
                <a class="editbtn" onclick=" $('#prod_visibility').val('1');$('#hiddenmsg').hide();saveProductFull();return false;" href="#">{$lang.show_product}</a>
            </div>
            <div class="imp_msg" style="margin-top:10px;{if $product.visible!=-1}display:none{/if}" id="archivemsg">
                ...
                <a class="editbtn" onclick=" $('#prod_visibility').val('1');$('#archivemsg').hide();saveProductFull();return false;" href="#">Restore product</a>
            </div>
        </td>
    </tr>
    <tr>
                ...
                <tr class="odd"> <td align="right" valign="top" width="200"><strong>{$lang.auto_create}</strong></td>
                    ...
                    <td id="automateoptions">
                        <input type="radio" value="0" name="autosetup2" {if $product.autosetup=='0' || $product.autosetup=='1'}checked="checked"{/if} 
                               id="autooff" onclick="$('#autosetup_opt').hide();$('#autooff_').click();"/>
                        ...
                        <input type="radio"  value="1" name="autosetup2" {if $product.autosetup!='0' && $product.autosetup!='1'}checked="checked"{/if} 
                               id="autoon" onclick="$('#autosetup_opt').ShowNicely();$('#autoon_').click();"/>
