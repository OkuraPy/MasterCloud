                    ...
                    <form action="" method="post" id="testform" ><input type="hidden" value="{$totalpages}" name="totalpages2" id="totalpages"/>
                        ...
                        <div class="blu">
                            ...
                            <div class="left menubar">
                                ...
                                <a onclick="return sendtoall_show()" class="menuitm" href="#"    style="margin-right: 10px;font-weight:bold;"><span >{$lang.sendmassemail}</span></a>
                                <a href="#" onclick="return false" id="hd1" class="menuitm clDropdown menul"><span class="morbtn">Import</span></a>
                    ...
                    <div class="blu">
                        <div class="menubar">
                            ...
                            {if $admindata.access.loginAsClient} <a   class=" menuitm menuf"  href="{$system_url2}?action=adminlogin&id={$client.client_id}" target="_blank"><span ><strong>{$lang.loginasclient}</strong></span></a>{/if}<a   class="menuitm menuc"   onclick="$('#ccinfo').toggle();
                                                return false" href="#" ><span >{$lang.ccardach}</span></a><a   class="menuitm clDropdown menul" id="hd1" onclick="return false"  href="#" ><span class="morbtn">{$lang.moreactions}</span></a>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr><td>
                                    ...
                                    <td style="padding-left:5px" valign="top">
                                        ...
                                        {if $mobilenotify}
                                            <div class="blu" >
                                                {$lang.SendTextMessage}: <select name="sms_id" id="sms_id">
