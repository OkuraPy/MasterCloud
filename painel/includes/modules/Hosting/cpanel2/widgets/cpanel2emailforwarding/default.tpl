                    ...
                    <tbody>
                        {foreach from=$dlist item=entry}
                            <tr>
                                ...
                                <td >{$entry.forward}</td>
                                <td >
                                    <a href="{$widget_url}&act=deldomain&domain={$entry.dest}&security_token={$security_token}">
                                        <span class="icon icon-trash" title="Remove"></span>
                                    </a>
                                </td>
                            </tr>
                ...
                <div class="modal hide fade" id="action-newfowarder">
                    <form action="{$widget_url}&act=addforwarder" method="POST" style="margin: 0">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <h3 class="span3">Address</h3>
                                <h3 class="span3">Destination</h3>
                            </div>
                            <div class="row">
                    ...
                    <form action="{$widget_url}&act=adddomainforwader" method="POST" style="margin: 0">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="control-group">
                                ...
                                <div class="row-fluid">
                                    <div class="span5">
                                        <select class="form-control span3" name="domain">
                                            {foreach from=$domains item=domain}
                                                <option value="{$domain}">{$domain}</option>
                                            {/foreach}
                                        </select>
