<div class="body-content">
    ...
    <div id="cjt_pagenotice_container" class="cjt-pagenotice-container cjt-notice-container">
        ...
        <div id="yui-gen10" class="yui-module cjt-notice cjt-pagenotice cjt-notice-info" style="display: block;">
            <div class="bd">
                <div class="cjt-notice-content">
                    When SSL certificate is installed onto one of your domains, it also installs the same certificate onto that domain’s “<code>www</code>” subdomain, and vice-versa. Unless your certificate matches both domains, however, only one of the two domains will show as a secure site in a user’s web browser.
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="section">
        <form enctype="multipart/form-data" method="post" name="mainform" action="{$widget_url}&act=install" id="mainform">
            ...
            <div class="control-group">
                ...
                <div class="row">
                    <div class="span3">
                        <textarea dir="ltr" class="form-control span3" name="crt" rows="10" id="sslcrt"></textarea>                   
                    </div>
                    <div class="span5">
            ...
            <div class="control-group">
                ...
                <div class="row">
                    <div class="span3">
                        <textarea dir="ltr" name="key" rows="10" class="form-control" id="sslkey"></textarea>
                    </div>
                    <div class="span5">
            ...
            <div class="control-group">
                ...
                <div class="row">
                    <div class="span3">
                        <textarea dir="ltr" name="cabundle" class="form-control" rows="10" id="sslcab"></textarea>
