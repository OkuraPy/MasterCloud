                    ...
                    <tbody>
                        {foreach from=$list item=entry}
                            <tr>
                                ...
                                <td >{if $entry.matchwww}<i class="icon icon-ok"></i>{/if}</td>
                                <td >{if $entry.wildcard}<i class="icon icon-ok"></i>{/if}</td>
                                <td >
                                    <a href="{$widget_url}&act=del&domain={$entry.urldomain}&path={$entry.source}&docroot={$entry.docroot}&security_token={$security_token}"
