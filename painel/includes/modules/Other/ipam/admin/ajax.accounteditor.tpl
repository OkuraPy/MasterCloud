                            ...
                            <tbody>
                                <tr>
                                    <td width="120" valign="top">
                                        <div style="padding:10px 0px;">
                                            <a onclick="return unassignIP('{$i}')" title="delete" class="menuitm menuf" href="#"><span class="rmsth">Unassign</span></a>{*}
                                            {*}<a onclick="return advEdit('{$ip.id}')" title="Edit details" class="menuitm menul" href="#"><span class="editsth"></span></a>
                                        </div>
                                    </td>
                                    <td >
                                        <b>
