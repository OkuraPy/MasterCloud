                        ...
                        <tr>
                            <td width="80" valign="top">
                                <div style="padding:10px 0px;">
                                    <a onclick="return editlist('{$group.id}')" href="#" class="menuitm menuf" title="Edit" style="display:inline-block;width:14px;">
            ...
            <table width="100%" cellspacing="0" cellpadding="5" border="0">
                <tbody>
                    <tr>
                        <td width="80" valign="top">
                            <div style="padding:10px 0px;">
                                <a onclick="return editlist('{$sub.id}')" href="#" class="menuitm menuf" title="Edit" style="display:inline-block;width:14px;">
                                    <span class="editsth"></span>
                                </a><!--
