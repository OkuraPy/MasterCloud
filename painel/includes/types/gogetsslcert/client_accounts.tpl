        ...
        <div class="wbox" >
            ...
            <div class="wbox_content">
                <table width="100%" cellspacing="0" cellpadding="0" border="0" class="checker">
                    ...
                    <tr>
                        <td style="border:none" colspan="2" align="center"><input type="submit" value="{$lang.continue}" style="font-weight:bold" class="padded btn" name="submit"/></td>
                    </tr>
                </table>
            </div>
        </div>
            ...
            <div class="wbox" >
                ...
                <div class="wbox_content">
                    <div id="firstform">
                        ...
                        <input type="submit" value="{$lang.savechanges}" name="submit2" style="font-weight:bold;display: block;margin: 5px auto;" class="padded btn"/>
                    </div>
                </div>
            </div>
            {*
                ...
                <div class="wbox">
                    ...
                    <div class="wbox_content">
                        <table width="100%" cellspacing="0" cellpadding="0" border="0" class="checker table table-striped">
                            <tr>
                                <td>{$lang.status}:</td>
                                <td><span class="label label-Active">{if $lang[$status.state]}{$lang[$status.state]}{else}{$status.state|capitalize}{/if}</span></td>
                            ...
                            <tr>
                                ...
                                <td>{$status.supplier_order_id}</td>
                            ...
                            <tr class="lastone ">
                                <td colspan="4" style="text-align: right">
                                    ...
                                    {if $status.state=='active' || $status.state=='active'}
                                        <input type="submit" value="{$lang.dwdcert}" name="submit" style="font-weight:bold" class="btn padded btn-success" onclick="$('#edo').val('resendcert')"/>
                                        <input type="submit" value="{$lang.downloadbundle}" name="submit" style="font-weight:bold" class="btn padded btn-success" onclick="$('#edo').val('resendca')"/>
                                    {/if}
                                    {if $status.is_renewable=='1'}
                                        <input type="submit" value="{$lang.renew}" name="submit" style="font-weight:bold" class="btn padded" onclick="$('#edo').val('renew')"/>
                                    {/if}
                                    <input type="submit" value="{$lang.synchronize}" name="submit" style="font-weight:bold" class="btn padded btn-info" onclick="$('#edo').val('Synchronize')"/>
