    ...
    <input type="hidden" name="config[conditional][{$k}][targetval]"  value="{$f.targetval}"/>
        ...
        {if $f.targetval} to {$f.targetval} {/if}
                    ...
                    <td valign="top" align="right">
                        <div style="padding:5px 0px;"><a href="#"  style="width:12px;height:14px;display:block" class="menuitm" title="delete" onclick="$('#condition_field_new_val').val(0);$('#conditional_{$k}').remove();saveChangesField(); return false"><span class="delsth"></span></a>
                        </div>
                    </td>
                </tr>
            </tbody>
